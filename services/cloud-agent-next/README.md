...
- `interruptSession` - Interrupt running execution
- `getWrapperLogs` - Get wrapper logs for debugging
...
- **Cloud → Kilo**: `prepareSession` creates a CLI session and links IDs.
